...
###filter DataFrame
df_data = int(df0.loc[df0[1] == 'データ数'].iloc[0,2])
...
_df0 = _df0[1:].astype(float)   # convert float

for i in range(4,7):
    _df0 = _df0[_df0[i]<=100]   # 100℃以下
